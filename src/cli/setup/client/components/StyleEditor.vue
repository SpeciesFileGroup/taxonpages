...
const DEFAULTS = {
  light: {
    ...
    '--tp-card-shadow': 'rgba(30, 41, 59, 0.04)',
    '--tp-card-border': 'rgba(98, 105, 118, 0.16)',
    '--tp-shadow-sm': 'rgba(0, 0, 0, 0.2)',
    '--tp-tree-line': 'rgb(100, 100, 100)',
    '--tp-footer-background': 'rgb(39, 39, 42)',
    '--tp-footer-content': 'rgb(255, 255, 255)',
    '--tp-footer-link': 'rgb(148, 163, 184)',
    '--tp-footer-link-hover': 'rgb(100, 116, 139)',
    '--tp-footer-border': 'rgb(107, 114, 128)',
  ...
  dark: {
    ...
    '--tp-card-shadow': 'rgba(0, 0, 0, 0.2)',
    '--tp-card-border': 'rgba(255, 255, 255, 0.08)',
    '--tp-shadow-sm': 'rgba(0, 0, 0, 0.4)',
    '--tp-tree-line': 'rgb(160, 160, 160)',
    '--tp-footer-background': 'rgb(23, 23, 23)',
    '--tp-footer-content': 'rgb(255, 255, 255)',
    '--tp-footer-link': 'rgb(148, 163, 184)',
    '--tp-footer-link-hover': 'rgb(203, 213, 225)',
    '--tp-footer-border': 'rgb(70, 70, 70)',
    '--tp-scrollbar-thumb': 'rgb(156, 163, 175)',
